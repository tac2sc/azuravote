(function (root, factory) {
  ...
  function createPublicPlayerAdapter(options) {
    ...
    function ensurePlayerUi(panel) {
      ...
      var radioWidgetRect = radioWidget && visibleRect(radioWidget);
      ...
      voting.style.top = (radioWidgetRect && panelRect ? Math.max(8, radioWidgetRect.top - panelRect.top - 22) : (mobile ? 148 : 175)) + "px";
